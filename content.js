(() => {
    ...
    const CONFIG = {
        PRANK_INTERVAL_MS: 500, // Timing for UI injections
    ...
    function runPranksterLogic() {
        ...
        // --- Photo Edit Buttons Injected Here ---
    ...
    // Initialize Prankster UI Injections
